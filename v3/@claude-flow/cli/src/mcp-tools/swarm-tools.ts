 ...
 * Includes OpenCode-compatible tool aliases.
 */
...
export const swarmTools: MCPTool[] = [
  ...
  {
    name: 'opencode_swarm_init',
    description: 'Initialize a swarm (OpenCode MCP alias)',
    category: 'swarm',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'opencode_swarm_status',
    description: 'Get swarm status (OpenCode MCP alias)',
    category: 'swarm',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'opencode_swarm_shutdown',
    description: 'Shutdown a swarm (OpenCode MCP alias)',
    category: 'swarm',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'opencode_swarm_health',
    description: 'Check swarm health (OpenCode MCP alias)',
    category: 'swarm',
    inputSchema: {
      type: 'object',
      properties: {
